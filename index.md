  ...
  <div class="carousel-viewport">
    <div class="articles-grid">
      ...
      <a href="ux-ui-design" class="article-card">
        ...
        <span class="card-excerpt">Entender a diferença entre UX e UI pode parecer complexo. Descubra como essas duas disciplinas se complementam para criar produtos digitais de sucesso.</span>
        <div class="card-footer">
          <span class="card-read">Ler artigo <span class="card-arrow">→</span></span>
        </div>
      </a>
